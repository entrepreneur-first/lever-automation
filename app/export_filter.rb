...
class ExportFilter
  HEADERS = ['Candidate ID', 'Profile Name', 'Name on Application', 'Application Created At', 'Application Values', 'Application Name', 'Posting ID', 'Opportunity ID', 'Stage Index', 'Stage Text', 'Stage Times', 'Origin','Sources','Tags','Links'].freeze
